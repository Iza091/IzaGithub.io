...
const Contact = () => {
  ...
  const handleChange = (e) => {
    ...
    setIsFormFilled(
      Object.values({ ...formData, [name]: value }).some(
        (val) => val.trim() !== ""
      )
    );
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/12caad11ec2019808c3e89130a656b01",
        {
          method: "POST",
          headers: {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="max-w-2xl mx-auto border-2 border-light-secondaryBorderSubtle dark:border-dark-secondaryBorderSubtle rounded-md p-6 bg-light-body dark:bg-dark-body shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  required
                  placeholder="Nombre"
                  className="w-full px-4 py-2 border-2 border-black dark:border-gray-300 text-light-text dark:text-gray-800 bg-white dark:bg-white rounded-md  focus:border-transparent placeholder-gray-500 dark:placeholder-gray-500 transition-all"
                />
              </div>
              <div>
                <label
